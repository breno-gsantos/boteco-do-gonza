...
import { Beef, Drumstick, Hamburger, Sandwich, Sparkles, UtensilsCrossed, Wine } from "lucide-react"
                    ...
                    <div className="grid gap-4">
                        {currentCategory?.items.map((item, index) => (
                            <div key={index} className={cn(
                                ...
                                : "border-border/50 hover:border-primary/20" )} style={{ animationDelay: `${index * 100}ms` }}>
                                    {item.isFeatured && (
