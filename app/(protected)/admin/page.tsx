...
import { ArrowDownRight, ArrowUpRight, CalendarDays, Clock, DollarSign, TrendingUp, Users, XCircle } from "lucide-react"
...
export default async function AdminPage() {
  const recentReservations: Reservation[] = await prisma.reservation.findMany({
    orderBy: [
      { date: "desc" },
      { time: "asc" },
    ],
